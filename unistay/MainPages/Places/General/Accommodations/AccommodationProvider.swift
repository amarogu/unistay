//
//  AccommodationProvider.swift
//  unistay
//
//  Created by Gustavo Amaro on 10/11/23.
//
...
struct AccommodationProvider: View {
    ...
    var body: some View {
        NavigationLink(destination: ActiveProviderAccommodation(pub: pub, location: [name, country], user: user), label: {
...
//ActiveProviderAccommodation(pub: newConn.publication, location: [name, country], user: user)
